            ...
            fill: function() {
                if (null != this.date && null != this.viewDate) {
                    var i = new Date(this.viewDate),
                        ...
                        g = new Date;
                    if (this.picker.find(".datetimepicker-days thead th:eq(1)").text(a+" "+n[this.language].months[o]), "time" == this.formatViewType) {
                        var v = l % 12 ? l % 12 : 12,
                            m = (10 > v ? "0": "") + v,
                            b = (10 > c ? "0": "") + c,
                    ...
                    } else this.picker.find(".datetimepicker-hours thead th:eq(1)").text(a+ " " + n[this.language].months[o] + " " + r ),
